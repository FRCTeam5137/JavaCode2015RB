...
public class OI {
    ...
    public OI() {
        ...
        lowerElevatorButton = new JoystickButton(driveStick, 9);
        lowerElevatorButton.whileHeld(new LowerElevator());
        raiseElevatorButton = new JoystickButton(driveStick, 7);
        ...
        pneumaticRetractButton = new JoystickButton(driveStick, 3);
        pneumaticRetractButton.whileHeld(new PneumaticRetract());
        pneumaticExtendButton = new JoystickButton(driveStick, 4);
        ...
        SmartDashboard.putData("Move Camera", new MoveCamera());
