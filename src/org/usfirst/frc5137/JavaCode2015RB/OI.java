...
public class OI {
    ...
    public JoystickButton binGrabberOnButton;
    public JoystickButton binGrabberOffButton;
    ...
    public OI() {
        ...
        pneumaticRetractButton = new JoystickButton(launchpad, 13);
        pneumaticRetractButton.whileHeld(new PneumaticRetract());
        pneumaticExtendButton = new JoystickButton(launchpad, 12);
        ...
        raiseElevatorButton.whileHeld(new RaiseElevator());
        pneumaticRetractButton = new JoystickButton(driveStick, 1);
        pneumaticRetractButton.whileHeld(new PneumaticRetract());
        pneumaticExtendButton = new JoystickButton(driveStick2, 1);
        pneumaticExtendButton.whileHeld(new PneumaticExtend());
        ...
        binGrabberOnButton = new JoystickButton(driveStick, 5);
        binGrabberOnButton.whenPressed(new BinGrabberOn());
        binGrabberOffButton = new JoystickButton(driveStick, 3);
        binGrabberOffButton.whenPressed(new BinGrabberOff());
